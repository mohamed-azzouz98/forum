...
<nav>
    <?php if (isset($_SESSION['login'])) { ?>
        <ul id="navul">
            <a href="index.php" class="lia">
                <li class="liheader">Accueil</li>
            </a>
            <a href="index.php"><img id="homebutton" img src="Images/home.png"></a>
            <a class="lia" href="profil.php?id=<?php echo "" . $_SESSION['id'] . ""; ?>">
                <li class="liheader">Profil</li>
            </a>
        </ul>
    <?php } else { ?>
        <ul id="navul">
            ...
            <a href="index.php"><img id="homebutton" img src="Images/home.png"></a>
            <a class="lia" href="inscription.php">
                <li class="liheader">Inscription</li>
            </a>
        </ul>
    <?php } ?>
</nav>